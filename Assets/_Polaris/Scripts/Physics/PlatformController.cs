...
namespace Polaris.Physics
{
    ...
    public class PlatformController : RaycastObject
    {
        ...
        private readonly Dictionary<Transform, RaycastController> _passengerCache = new();
        ...
        private void MovePassengers(bool beforeMovePlatform)
        {
            foreach (var passenger in _passengers)
            {
                ...
                {
                   _passengerCache.Add(passenger.Transform, passenger.Transform.GetComponent<RaycastController>()); 
                }
